...
<h3 align="center">Data Analyst with expertise in data analysis and reporting, query optimization, database design, and data modelling. Querying data using SQL. Generate reports and perform ad-hoc data analysis using SQL. Developing dashboards on Tableau. Data analysis and reporting using Google Sheets and Excel. Successfully implemented data integration solutions using Snowflake as the data warehouse platform in a GCP environment.</h3>
